#include "less-than-opcode.h"
#include <iostream>

LessThanOpCode::LessThanOpCode()
{

}

OpCode::HaltExecution LessThanOpCode::execute(std::shared_ptr<std::vector<int>> execution_env, std::vector<int>& param_modes, int& current_position) {
    ...
    (*execution_env.get())[out_position] = val1 < val2 ? 1 : 0;

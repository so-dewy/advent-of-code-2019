#include "jump-if-false-opcode.h"
#include <iostream>

JumpIfFalseOpCode::JumpIfFalseOpCode()
{

}

OpCode::HaltExecution JumpIfFalseOpCode::execute(std::shared_ptr<std::vector<int>> execution_env, std::vector<int>& param_modes, int& current_position) {

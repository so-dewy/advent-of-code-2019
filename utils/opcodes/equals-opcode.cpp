#include "equals-opcode.h"
#include <iostream>

EqualsOpCode::EqualsOpCode()
{

}

OpCode::HaltExecution EqualsOpCode::execute(std::shared_ptr<std::vector<int>> execution_env, std::vector<int>& param_modes, int& current_position) {
